<?php
/**
 * Plugin Name:       Viewport Triggered Animations
 * Description:       Adds short codes in order to animate text elements when they enter the vieport
 * Plugin URI:        https://firstonewebdev.com
 * Version:           1.0.0
 * Author:            Peter Hauser
 * Author URI:        https://firstonewebdev.com
 * Requires at least: 3.0.0
 * Tested up to:      4.4.2
 *
 * @package Viewport_Triggered_Animations
 */
...
/**
 * Main Viewport_Triggered_Animations Class
 *
 * @class Viewport_Triggered_Animations
 * @version	1.0.0
 * @since 1.0.0
 * @package	Viewport_Triggered_Animations
 */
final class Viewport_Triggered_Animations 
{
	/**
	 * Set up the plugin
	 */
...
{
	new Viewport_Triggered_Animations();
}
